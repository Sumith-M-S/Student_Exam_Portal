...
class reportClass:
    def __init__(self,root):
        ...
        self.var_id=""
        lbl_search=Label(self.root,text="Search By Roll No.",font=("goudy old style",20,"bold"),bg="white").place(x=280,y=105)
        txt_search=Entry(self.root,textvariable=self.var_search,font=("goudy old style",20),bg="lightyellow").place(x=520,y=105,width=150)
        btn_Search=Button(self.root,text="Search",font=("goudy old style",15,"bold"),bg="#6f25ca",fg="white",cursor="hand2",command=self.search).place(x=680,y=105,width=100,height=35)
        btn_Clear=Button(self.root,text="Clear",font=("goudy old style",15,"bold"),bg="gray",fg="white",cursor="hand2",command=self.clear).place(x=800,y=105,width=100,height=35)
        ...
        lbl_marks=Label(self.root,text="Marks_Obtained",font=("goudy old style",15,"bold"),bg="white",bd=2,relief=GROOVE).place(x=600,y=230,width=150,height=50)
        lbl_full=Label(self.root,text="Total_Marks",font=("goudy old style",15,"bold"),bg="white",bd=2,relief=GROOVE).place(x=750,y=230,width=150,height=50)
        ...
        #Delete********
        btn_Delete=Button(self.root,text="Delete",font=("goudy old style",15,"bold"),bg="red",fg="white",cursor="hand2",command=self.delete).place(x=550,y=350,width=100,height=35)
        #search**************
    def search(self):
        ...
        try:
            if self.var_search.get()=="":
                messagebox.showerror("Error","roll no should be requied",parent=self.root)
            else:
